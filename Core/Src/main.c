...
/* Definitions for sensorTask_Init */
osThreadId_t sensorTask_InitHandle;
const osThreadAttr_t sensorTask_Init_attributes = {
  .name = "sensorTask_Init",
  .stack_size = 128 * 4,
...
/**
  * @brief  Function implementing the sensorTask_Init thread.
